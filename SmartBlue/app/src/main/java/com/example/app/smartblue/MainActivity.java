...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        super.onStart();
        Toast.makeText(this, "액티비티 시작",Toast.LENGTH_LONG).show();
    }

    @Override
    protected void onStop() {
        super.onStop();
        Toast.makeText(this, "액티비티 정지",Toast.LENGTH_LONG).show();
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        Toast.makeText(this, "액티비티 종료",Toast.LENGTH_LONG).show();
